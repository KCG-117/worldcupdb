...
echo "$($PSQL "SELECT DISTINCT(name) FROM teams FULL JOIN games g1 ON teams.team_id=g1.winner_id FULL JOIN games g2 ON teams.team_id=g2.opponent_id WHERE (g1.round='Eighth-Final' OR g2.round='Eighth-Final') AND (g1.year=2014 OR g2.year=2014);")"
